...
describe('Besoin 2 : Maitre D‘Hotel', () => {
    describe('avec deux capacité privées pour deux et deux capacité privés pour quatre, sans réservations enregistré', () => {
        ...
        it('réservé pour quatre personnes, le 2024-06-07 = la demande est accepté', () => {
            expect(maitreD.peutAccepter(
                    new DemandeDeRéservation(4, '2024-06-07'
                )
            )).toEqual(true)
        })
        it('la demande est pour cinq personnes, le 2024-06-07 = la demande est rejeté', () => {
            expect(maitreD.peutAccepter(
    ...
    describe('avec deux capacité privées et une table privée pour quatre personne', () => {
        ...
        describe('avec une réservations enregistré de 2 personnes, le 2024-06-07', () => {
            ...
            it('la demande est pour 2 personnes, le 2024-06-07 = la demande est accepté', () => {
                expect(maitreD.peutAccepter(
        ...
        describe('avec une réservations enregistré de 3 personnes, le 2024-06-07', () => {
            ...
            it('la demande est pour 3 personnes, le 2024-06-07 =  la demande est rejeté', () => {
                expect(maitreD.peutAccepter(
